#!/usr/bin/env bash
# install.sh — Bootstrap do "Hermes Imobiliária (Squad) by CCB".
# Uso (one-liner):
#   curl -fsSL https://raw.githubusercontent.com/kleinelizeu/imobiliaria-squad-ccb/main/install.sh | sudo bash
#
# Clona/atualiza o repositório, cria o comando global 'hermes-imobiliaria' e abre o assistente.
...
PRODUTO="imobiliaria-squad-ccb"
PRODUTO_NOME="Hermes Imobiliária (Squad) by CCB"
CLI_NAME="hermes-imobiliaria"
REPO_URL="${PRODUTO_REPO:-https://github.com/kleinelizeu/imobiliaria-squad-ccb.git}"
